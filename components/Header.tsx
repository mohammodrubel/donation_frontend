      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            <div className="w-9 h-9 rounded-lg bg-primary text-white flex items-center justify-center font-bold text-lg group-hover:shadow-lg transition-all duration-200">
              D
            </div>
          ...
          <nav className="hidden md:flex items-center gap-1">
            <Link
              href="/campaigns"
              className="px-4 py-2 text-foreground/70 hover:text-primary font-medium transition-colors"
            >
              Campaigns
            </Link>
            <Link
        ...
        {isMenuOpen && (
          <nav className="md:hidden pb-4 border-t border-border/40 space-y-1 animate-in slide-in-from-top-2">
            <Link
              href="/campaigns"
              className="block px-4 py-3 text-foreground/80 hover:bg-primary/5 rounded-lg transition-colors font-medium"
            >
              Campaigns
            </Link>
            <Link
