...
import { Heart, BarChart3, Users, Gift, TrendingUp, AlertCircle, Settings, Menu, X, LogOut } from 'lucide-react'
import Link from 'next/link'

const sidebarItems = [
  { icon: BarChart3, label: 'Analytics', href: '/admin' },
  { icon: Users, label: 'Users', href: '/admin/users' },
  { icon: TrendingUp, label: 'Campaigns', href: '/admin/campaigns' },
  { icon: Gift, label: 'Item Pickups', href: '/admin/pickups' },
    ...
    <div className="flex h-screen bg-background">
      ...
      >
        ...
        <div className="px-6 py-3 bg-primary/10 border-b border-border">
          <p className="text-xs font-semibold text-primary uppercase">Admin Panel</p>
        </div>
